  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox again - your premier marketplace connecting talented freelancers with companies offering jobs. Empowering you to reach your full potential."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox again - your premier marketplace connecting talented freelancers with companies offering jobs. Empowering you to reach your full potential.`}
            </Text>
            <Box
